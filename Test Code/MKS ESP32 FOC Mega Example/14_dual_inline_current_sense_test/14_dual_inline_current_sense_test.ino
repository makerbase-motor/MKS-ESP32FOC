//MKS ESP32 FOC Mega In-line Current Sensing Example Librart: SimpleFOC 2.2.1 Hardware: MKS ESP32 FOC PLUS
...
void loop() {
  ...
  if (count >= 50) {
    ...
    //You can plot waveforms using a serial port utility.
